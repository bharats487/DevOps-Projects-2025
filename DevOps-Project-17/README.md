...
[![DevOps-Project-24: DotNet Monitoring](https://img.shields.io/badge/Project-DotNet%20Monitoring-brightgreen)](https://github.com/bharats487/DevOps-Projects/tree/master/DevOps-Project-24/DotNet-monitoring)
...
pipeline {
    ...
    stages {
        ...
        stage('Checkout From Git') {
            steps {
                git branch: 'master', url: 'https://github.com/bharats487/DevOps-Projects/tree/master/DevOps-Project-24/DotNet-monitoring'
            }
        }
...
stage("Docker Build & tag"){
        ...
        stage("TRIVY"){
            steps{
                sh "trivy image bharats487/dotnet-monitoring:latest > trivy.txt" 
            }
        }
        stage("Docker Push"){
            steps{
...
stage("Deploy to container"){
            steps{
                sh "docker run -d --name dotnet -p 5000:5000 bharats487/dotnet-monitoring:latest"
            } 
        }
```
