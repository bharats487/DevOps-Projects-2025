...
**GITHUB REPO**: [Chatbot-UI](https://github.com/bharats487/DevOps-Projects/tree/master/DevOps-Project-28/Chatbot-UI)

```
git clone https://github.com/bharats487/DevOps-Projects/DevOps-Project-28/Chatbot-UI
...
pipeline{
    ...
    stages {
        stage('Checkout from Git'){
            steps{
                git branch: 'master', url: 'https://github.com/bharats487/DevOps-Project-28/Chatbot-UI.git'
            }
        }
            ...
            steps{
                script{
                   withDockerRegistry(credentialsId: 'docker', toolName: 'docker'){   
                       ...
                       sh "docker tag chatbot DevOps with BharatTech/chatbot:latest "
                       sh "docker push DevOps with BharatTech/chatbot:latest "
                    }
                }
            }
        }
        stage("TRIVY"){
            steps{
                sh "trivy image DevOps with BharatTech/chatbot:latest > trivy.json" 
            }
        }
