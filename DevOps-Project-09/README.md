...
[Deploy Two-Tier Architecture on AWS using Terraform](https://blog.DevOps with Bharat.xyz/deploy-two-tier-architecture-on-aws-using-terraform)  
...
```bash
git clone https://github.com/bharats487/DevOps-Projects
