...
2. **GitHub Account and Repository**:
   ...
   - Fork the Java source code from the [Java-Login-App repository](https://github.com/bharats487/DevOps-Projects/blob/master/DevOps-Project-01/Java-Login-App) to your GitHub account.
